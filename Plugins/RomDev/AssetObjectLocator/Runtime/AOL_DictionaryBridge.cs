...
{
    [Serializable]
    public class AOL_DictionaryBridge<Tkey, Tvalue>
    {
        ...
        #endregion
        public bool CopyToDictionary(Dictionary<Tkey, Tvalue> targetDict)
        {
            ...
            {
                targetDict.Add(keys[i], values[i]);
            }
            return true;
        }
        ...
        public Tvalue GetCopy(Tkey _key)
        {
            ...
            return AOL_Helper.DeepCopy(values[keyIndex]);
        }
        public void Clear()
        {
            keys.Clear();
